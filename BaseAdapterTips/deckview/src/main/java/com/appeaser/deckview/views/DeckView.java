...
//                }
    ...
    private boolean updateStackTransforms(ArrayList<DeckChildViewTransform> taskTransforms,
        ...
        for (int i = taskCount - 1; i >= 0; i--) {
            ...
            Log.d("updateStackTransforms","------------------------translation------------------------");
            Log.d("updateStackTransforms","translationY : "+ transform.translationY);
            Log.d("updateStackTransforms","translationZ : "+ transform.translationZ);
        }
        Log.d("updateStackTransforms","========================================");
...
//    }
    ...
    public ArrayList<DeckChildViewTransform> getCurrentTaskTransforms() {
        return mCurrentTaskTransforms;
    }
