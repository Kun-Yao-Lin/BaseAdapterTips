package tw.com.arnold_lin.library.adapters.feature.views;
...
public class TemplateView extends LinearLayout implements ViewBinderImp<TemplateView.Binder> {
    ...
    public static class Type extends FeatureType<TemplateView> {
    }

    public static class Binder extends tw.com.arnold_lin.library.adapters.feature.binders.Binder<TemplateView> {
    }
}
