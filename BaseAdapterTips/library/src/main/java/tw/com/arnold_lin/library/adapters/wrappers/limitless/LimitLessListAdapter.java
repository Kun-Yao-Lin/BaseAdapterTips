package tw.com.arnold_lin.library.adapters.wrappers.limitless;
...
import tw.com.arnold_lin.library.adapters.wrappers.WrapperBaseAdapterImpl;
...
public class LimitLessListAdapter extends WrapperBaseAdapterImpl implements AbsListView.OnScrollListener {
    ...
    @Override
    public int getCount() {
        if(dynamicCount == 0 || dynamicCount > wrapped.getCount()){
