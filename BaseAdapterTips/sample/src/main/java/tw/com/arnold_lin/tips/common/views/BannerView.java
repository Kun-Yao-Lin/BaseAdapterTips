package tw.com.arnold_lin.tips.common.views;
...
import tw.com.arnold_lin.library.adapters.common.feature.core.FeatureType;
...
//        setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,imageHeight));
        ...
        mIndicator.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT, Gravity.BOTTOM));
    ...
    @Override
    public void setBinder(BannerView.Binder binder) {
    ...
    public static class Type extends FeatureType<BannerView> {
    }
